...
//		arrayCopyFor();
	...
	private static void arrayCopyFor() {
		...
		int source[] = {1, 2, 3};
		int target[] = new int [10];	//	10개 배열  새배열을 만들어준다
	...
	private static void twoDimens() {
		...
		System.out.println("lenght of table:" + table.length);
	...
	private static void arrayBasic() {
		...
		scores[2] = 75;
		scores[3] = 95;
//		scores[4] = 100;	// 에러 인덱스 범위를 벗어난 접근은 불가 (인덱스값-1)
...
//		System.out.println(scores);
		...
		int[] scores2 = scores;	//	참조 복사: 내용은 동일하나 주소만 복사
