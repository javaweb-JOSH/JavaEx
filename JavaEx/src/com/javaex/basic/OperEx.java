...
//		bitShiftEx();
	...
	private static void bitShiftEx() {
		...
		System.out.println(Integer.toBinaryString(val <<2)); //	왼쪾으로 2비트 이동
	...
	private static void logialOperEx() {
		...
		System.out.println("a not equal b ?" + (a != b));	//	!= 같지않다
	...
	private static void arithOperEx() {
		...
		// 두 피연산자를 산술연산 -> 타입을 큰쪾으로 맞춘다
		System.out.println((float)a / b);	//	7.0 / 3.0
		
		// 증감연산(++, --)
		// 복잡한 연산식 내에 포함하지 말고 단순 증감 용도로만 사용 (*팁*)
		int c = 10;
		...
		// Infinity, NaN
		System.out.println((float)d / 0);	// 10.0 / 0
