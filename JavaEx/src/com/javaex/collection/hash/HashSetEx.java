...
//		basicHashSetEx();
	...
	private static void customHashSetEx() {
		...
		System.out.println("hashcode of s4:" + s4.hashCode());	//	1차 검증 hashcode
		System.out.println("s1 equals s4 ? " + s1.equals(s4));	//	2차 검증 equals
	...
	private static void basicHashSetEx() {
		...
		System.out.println("HashSet:" + hs);	//	순서는 유효하지 않음
