...
public class WrapperEx {
	...
	public static void main(String[] args) {
		//	만들기
		//	deprecated: 향후 삭제될 예정 -> 빠른 시간 내에 다른 방식으로 코딩 (선 그어짐)
		...
		System.out.println(Integer.toBinaryString(28));	//	28을 2진수 형태의 문자열로"
		System.out.println(Integer. toHexString(28));	//	28을 16진수 형태의 문자열로"
